      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.timeline}>
          ...
          <View style={styles.timelineItem}>
            ...
            <View style={styles.timelineContent}>
              <Text style={[styles.timelineTitle, {color: colors.primary}]}>Đang trên đường</Text>
...
const getStyles = (colors: any, spacing: any, fontSize: any) => StyleSheet.create({
  ...
  mapPlaceholder: { height: 260, backgroundColor: colors.border, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginBottom: -40, marginHorizontal: -16 },
  mapText: { marginTop: 8, color: colors.textSecondary, fontSize: 14, fontWeight: '500' },
  trackingCard: { backgroundColor: colors.surface, borderRadius: 16, padding: 16, marginBottom: 24, elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12 },
  ...
  badgeText: { color: colors.success, fontSize: 12, fontWeight: '700', marginLeft: 4 },
  etaText: { fontSize: 24, fontWeight: '800', color: colors.text, marginBottom: 2 },
  ...
  dot: { width: 16, height: 16, borderRadius: 8, backgroundColor: colors.surface, borderWidth: 4, borderColor: colors.border, marginTop: 2, zIndex: 2 },
  dotDone: { borderColor: colors.success },
  dotCurrent: { borderColor: colors.primary, borderWidth: 5 },
  ...
  timelineLine: { position: 'absolute', left: 15, width: 2, height: '100%', backgroundColor: colors.border, zIndex: 1 },
  timelineLineDone: { position: 'absolute', left: 15, width: 2, height: '100%', backgroundColor: colors.success, zIndex: 1 },
